...
|---|---|
| Home — headshot + 3 photos around it (grad, Betsy & Bernie, notepad) | `images/home/headshot.svg`, `grad-photo.svg`, `betsy-bernie.svg`, `notepad.svg` |
...
```css
--color-bg: #FBFAF8;         /* page background — near-white */
...
The palette is light gray + light pink + off-white, pulled from your color
photo but lightened: gray carries the "functional" parts of the site
